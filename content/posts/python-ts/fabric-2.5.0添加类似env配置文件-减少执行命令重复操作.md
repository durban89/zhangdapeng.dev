...
slug: "fabric-2-5-0-tian-jia-lei-si-env-pei-zhi-wen-jian-jian-shao-zhi-xing-ming-ling-chong-fu-cao-zuo"
categories: ["技术"]
tags: ["Python", "Fabric"]
aliases:
  - "/2025/07/30/fabric-2.5.0添加类似env配置文件-减少执行命令重复操作"
  - "/2025/07/30/fabric-2.5.0添加类似env配置文件-减少执行命令重复操作/"
  - "/2025/07/30/fabric-2.5.0添加类似env配置文件减少执行命令重复操作/"
---
