---
title: "Python 入门基础知识 - 多媒体编程 - PIL处理图片之生成缩略图"
date: "2025-07-28T17:39:07.136875+08:00"
draft: false
slug: "python-ru-men-ji-chu-zhi-shi-duo-mei-ti-bian-cheng-pil-chu-li-tu-pian-zhi-sheng-cheng-suo-lve-tu"
categories: ["技术"]
tags: ["Python", "多媒体编程"]
aliases:
  - "/2025/07/28/python-入门基础知识-多媒体编程-pil处理图片之生成缩略图"
  - "/2025/07/28/python-入门基础知识-多媒体编程-pil处理图片之生成缩略图/"
---

**生成缩略图**

使用PIL生成缩略图主要是使用Image的size函数。使用size函数可以重新指定图片的大小，代码实例如下，使用PIL模块批量生成图片缩略图
...
class Window:
    ...
    def BrowserFile(self):
        file = tkFileDialog.askopenfilename(title='Python Music Player', filetypes=[('JPG','*.jpg'),('BMP', '*.bmp'),('PNG', '*.png'),('GIF', '*.gif')])
        if file:
...
![Image](https://cdn.xiaorongmao.com/up/120-1.png)
